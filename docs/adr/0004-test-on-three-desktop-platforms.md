...
> This historical test decision is retained for context. The platform matrix remains, but current desktop E2E tests target the Tauri shell.
...
- Tauri end-to-end tests that launch the unpacked Desktop application and verify startup-page transition, the loaded Web UI, single-instance focus behavior, and a startup-failure surface. Linux runs the GUI tests under Xvfb.
