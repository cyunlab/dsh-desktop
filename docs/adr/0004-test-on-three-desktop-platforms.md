...
- integration tests that boot the real pinned Harness composition with temporary `DSH_HOME` and fallback-workspace directories, then verify OS-assigned port discovery, loopback HTTP/API readiness, and graceful disposal;
