...
await Promise.all([
  build({ entryPoints: ['src/main/index.ts'], outfile: 'dist/main/index.js', bundle: true, platform: 'node', format: 'esm', external: ['electron', '@deepseek-ai/*', 'node-addon-require-builtin'], sourcemap: true }),
